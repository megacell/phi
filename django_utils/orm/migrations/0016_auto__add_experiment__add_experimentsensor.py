...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'orm_experiment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('run_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'orm', ['Experiment'])

        # Adding model 'ExperimentSensor'
        db.create_table(u'orm_experimentsensor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('experiment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orm.Experiment'])),
            ('sensor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orm.Sensor'])),
        ...
        db.send_create_signal(u'orm', ['ExperimentSensor'])


    def backwards(self, orm):
        # Deleting model 'Experiment'
        db.delete_table(u'orm_experiment')

        # Deleting model 'ExperimentSensor'
        db.delete_table(u'orm_experimentsensor')
