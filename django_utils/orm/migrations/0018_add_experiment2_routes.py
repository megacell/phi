...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Experiment2Route'
        db.create_table(u'orm_experiment2route', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('geom', self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')()),
            ('geom_dist', self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')(srid=900913, null=True, blank=True)),
            ('origin_taz', self.gf('django.db.models.fields.FloatField')()),
            ('destination_taz', self.gf('django.db.models.fields.FloatField')()),
            ('od_route_index', self.gf('django.db.models.fields.IntegerField')()),
            ('flow_count', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'orm', ['Experiment2Route'])

        # Adding unique constraint on 'Experiment2Route', fields ['origin_taz', 'destination_taz', 'od_route_index']
        db.create_unique(u'orm_experiment2route', ['origin_taz', 'destination_taz', 'od_route_index'])

        # Adding index on 'Experiment2Route', fields ['origin_taz', 'destination_taz']
        db.create_index(u'orm_experiment2route', ['origin_taz', 'destination_taz'])


    def backwards(self, orm):
        # Removing index on 'Experiment2Route', fields ['origin_taz', 'destination_taz']
        db.delete_index(u'orm_experiment2route', ['origin_taz', 'destination_taz'])

        # Removing unique constraint on 'Experiment2Route', fields ['origin_taz', 'destination_taz', 'od_route_index']
        db.delete_unique(u'orm_experiment2route', ['origin_taz', 'destination_taz', 'od_route_index'])

        # Deleting model 'Experiment2Route'
        db.delete_table(u'orm_experiment2route')
