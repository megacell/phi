...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Origin.geom_dist'
        db.alter_column(u'orm_origin', 'geom_dist', self.gf('django.contrib.gis.db.models.fields.PolygonField')(srid=900913, null=True))

    def backwards(self, orm):

        # Changing field 'Origin.geom_dist'
        db.alter_column(u'orm_origin', 'geom_dist', self.gf('django.contrib.gis.db.models.fields.PolygonField')(srid=990913, null=True))
