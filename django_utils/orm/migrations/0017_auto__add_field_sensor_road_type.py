...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sensor.road_type'
        db.add_column(u'orm_sensor', 'road_type',
                      self.gf('django.db.models.fields.CharField')(default='Freeway', max_length=50, null=True, blank=True),
                      keep_default=True)


    def backwards(self, orm):
        # Deleting field 'Sensor.road_type'
        db.delete_column(u'orm_sensor', 'road_type')
    ...
    models = {
        ...
        u'orm.sensor': {
            ...
            'road_type': ('django.db.models.fields.CharField', [], {'default': "'Highway'", 'max_length': '50', 'null': 'True', 'blank': 'True'}),
