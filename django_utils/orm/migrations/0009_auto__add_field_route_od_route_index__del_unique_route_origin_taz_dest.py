...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Route', fields ['origin_taz', 'destination_taz']
        db.delete_unique(u'orm_route', ['origin_taz', 'destination_taz'])

        # Adding field 'Route.od_route_index'
        db.add_column(u'orm_route', 'od_route_index',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding unique constraint on 'Route', fields ['origin_taz', 'destination_taz', 'od_route_index']
        db.create_unique(u'orm_route', ['origin_taz', 'destination_taz', 'od_route_index'])


    def backwards(self, orm):
        # Removing unique constraint on 'Route', fields ['origin_taz', 'destination_taz', 'od_route_index']
        db.delete_unique(u'orm_route', ['origin_taz', 'destination_taz', 'od_route_index'])

        # Deleting field 'Route.od_route_index'
        db.delete_column(u'orm_route', 'od_route_index')

        # Adding unique constraint on 'Route', fields ['origin_taz', 'destination_taz']
        db.create_unique(u'orm_route', ['origin_taz', 'destination_taz'])
    ...
    models = {
        ...
        u'orm.route': {
            'Meta': {'unique_together': "(('origin_taz', 'destination_taz', 'od_route_index'),)", 'object_name': 'Route'},
