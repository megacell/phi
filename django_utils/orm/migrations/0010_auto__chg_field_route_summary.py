...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Route.summary'
        db.alter_column(u'orm_route', 'summary', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Route.summary'
        db.alter_column(u'orm_route', 'summary', self.gf('django.db.models.fields.CharField')(max_length=50))
