...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MatrixTaz'
        db.create_table(u'orm_matrixtaz', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('matrix_id', self.gf('django.db.models.fields.IntegerField')()),
            ('taz_id', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'orm', ['MatrixTaz'])


    def backwards(self, orm):
        # Deleting model 'MatrixTaz'
        db.delete_table(u'orm_matrixtaz')
