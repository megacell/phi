...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExperimentRoute'
        db.create_table(u'orm_experimentroute', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('route', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orm.Route'])),
            ('vector_index', self.gf('django.db.models.fields.IntegerField')()),
            ('value', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('true_split', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'orm', ['ExperimentRoute'])

        # Adding index on 'Route', fields ['origin_taz', 'destination_taz']
        db.create_index(u'orm_route', ['origin_taz', 'destination_taz'])


    def backwards(self, orm):
        # Removing index on 'Route', fields ['origin_taz', 'destination_taz']
        db.delete_index(u'orm_route', ['origin_taz', 'destination_taz'])

        # Deleting model 'ExperimentRoute'
        db.delete_table(u'orm_experimentroute')


    models = {
        u'orm.experimentroute': {
            'Meta': {'object_name': 'ExperimentRoute'},
