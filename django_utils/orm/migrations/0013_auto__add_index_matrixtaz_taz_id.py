...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'MatrixTaz', fields ['taz_id']
        db.create_index(u'orm_matrixtaz', ['taz_id'])


    def backwards(self, orm):
        # Removing index on 'MatrixTaz', fields ['taz_id']
        db.delete_index(u'orm_matrixtaz', ['taz_id'])
